...
# After the files are created to prevent the keys from regenerating I deleted the previous code and using the same algorithm so the keys will be in my script 
